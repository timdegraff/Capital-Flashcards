...
const statesData = {
    ...
    "Arizona": { capital: "Phoenix", facts: ["Home to the Grand Canyon.", "Has the most telescopes in the world in Tucson.", "Known for its saguaro cacti.", "Home to the Barringer Crater, a meteorite impact site nearly one mile across?", "A top spot for stargazing."] },
    ...
    "Colorado": { capital: "Denver", facts: ["Known as the Centennial State.", "Has the Rocky Mountains.", "Has the highest average elevation in the United States?", "A top spot for skiing.", "Has the highest sand dunes in North America."] },
    ...
    "North Carolina": { capital: "Raleigh", facts: ["Known as the Tar Heel State.", "Home to the tallest lighthouse in the U.S., the Cape Hatteras Lighthouse?", "Home to the Wright Brothers’ first flight.", "Known for its tobacco production.", "Has beautiful beaches."] },
    ...
    "South Carolina": { capital: "Columbia", facts: ["Known as the Palmetto State.", "Home to the only large-scale commercial tea plantation in North America?", "Home to Myrtle Beach.", "Started the Civil War at Fort Sumter.", "Known for its plantations."] },
    ...
    "Vermont": { capital: "Montpelier", facts: ["Known as the Green Mountain State.", "Produces the most maple syrup in the U.S.?", "Known for its ski resorts.", "Has the smallest state capital by population.", "Famous for its dairy farms?"] },
    ...
    "Wisconsin": { capital: "Madison", facts: ["Known as the Badger State.", "Produces the most cheese in the United States?", "Home to the Harley-Davidson Museum.", "Known for its dairy farms.", "Has beautiful lakes."] },
